...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiSimpleBrowseBack({required int sessionId, dynamic hint});

  Future<void> crateApiSimpleBrowseNextPage({dynamic hint});
  ...
  Future<void> crateApiSimpleControl({required Control control, dynamic hint});

  Future<void> crateApiSimpleControlByZoneId(
      {required String zoneId, required Control control, dynamic hint});

  Future<void> crateApiSimpleGetImage({required String imageKey, dynamic hint});

  Future<void> crateApiSimpleGroupOutputs(
      {required List<String> outputIds, dynamic hint});
  ...
  Future<void> crateApiSimpleMuteAll({dynamic hint});

  Future<void> crateApiSimpleMuteZone({dynamic hint});

  Future<void> crateApiSimplePauseAfterQueueItems(
      {required List<int> queueItemIds, dynamic hint});

  Future<void> crateApiSimplePauseAll({dynamic hint});

  Future<void> crateApiSimplePauseOnTrackEnd({dynamic hint});

  Future<void> crateApiSimpleQueryProfile(
      {required int sessionId, dynamic hint});

  Future<void> crateApiSimpleSaveSettings(
      {required String settings, dynamic hint});
  ...
  Future<void> crateApiSimpleSelectQueueItem(
      {required int queueItemId, dynamic hint});

  Future<void> crateApiSimpleSelectZone({required String zoneId, dynamic hint});

  Future<void> crateApiSimpleSetServerProperties(
      {required String ip, String? port, dynamic hint});

  Future<void> crateApiSimpleStandby({required String outputId, dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  @override
  Future<void> crateApiSimpleGetImage(
      {required String imageKey, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
  ...
  @override
  Future<void> crateApiSimpleSelectZone(
      {required String zoneId, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(zoneId, serializer);
